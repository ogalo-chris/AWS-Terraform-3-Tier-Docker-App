...
module "vpc" {
  ...
  public_subnet_azs      = var.availability_zones
  private_subnet_azs     = var.availability_zones

  public_subnet_cidr     = var.public_subnet_cidrs
  private_frontend_cidr  = var.frontend_subnet_cidrs
  private_backend_cidr   = var.backend_subnet_cidrs
  private_database_cidr  = var.database_subnet_cidrs
...
module "security_groups" {
  ...
  bastion_allowed_ips = [var.allowed_ssh_cidr]
